export const messages = {
  ...
  askBirthTimeExact:
    ...
    // NEW: approximate time prompt (flexible)
  askBirthTimeApprox:
  ...
  paymentIssueInvalidOption: "Reply 1 or 2.",
